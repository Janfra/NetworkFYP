...
> [!NOTE]
> Project [DefaultEngine.ini](Config/DefaultEditor.ini) configuration file will not be updated directly for security concerns, please instead refer to the [DefaultEngine_GitSafeCopy.txt](Config/DefaultEngine_GitSafeCopy.txt) instead.
